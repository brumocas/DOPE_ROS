...
let DopeSkillGoal = require('./DopeSkillGoal.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class DopeSkillActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = DopeSkillGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += DopeSkillGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new DopeSkillActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = DopeSkillGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new DopeSkillGoal()
    }
...
module.exports = DopeSkillActionGoal;
